declare @palabra1 varchar(20),
		@palabra2 varchar(20),
		@longitud_palabra1 int,
		@contador int,
		@letra varchar(20),
		@sql nvarchar(4000),
		@columna nvarchar(10)
...
set @palabra1='martha'
set @contador=1
select @longitud_palabra1=LEN(@palabra1) 
set @sql='create table nombre ('
while @contador<=@longitud_palabra1
begin
  set @letra=LEFT(@palabra1, 1)+cast(@contador as varchar(1)) + ' int,'
...
set @palabra2='marta'
set @contador=1
select @longitud_palabra2=LEN(@palabra2) 
while @contador<=@longitud_palabra2
begin
  set @letra=LEFT(@palabra2, 1)
  set @palabra1=RIGHT(@palabra2, LEN(@palabra2)-1)
